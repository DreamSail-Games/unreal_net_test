...
void ANetTestGameMode::BeginPlay()
{
...
void ANetTestGameMode::SendServerHeartbeat()
{
	if (Role == ROLE_Authority)
	{
		...
		Request->OnProcessRequestComplete().BindUObject(this, &ANetTestGameMode::OnHttpRequestReceived);
...
void ANetTestGameMode::OnHttpRequestReceived(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful)
{
