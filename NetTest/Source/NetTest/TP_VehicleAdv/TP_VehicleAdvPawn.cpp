...
void ATP_VehicleAdvPawn::ConnectToServerWithIP(FString ipAddr)
{
...
void ATP_VehicleAdvPawn::ListServers()
{
	if (Role == ROLE_Authority)
	{
		...
		Request->OnProcessRequestComplete().BindUObject(this, &ATP_VehicleAdvPawn::OnHttpRequestReceived);
